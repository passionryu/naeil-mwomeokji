...
(function (root) {
  ...
  const RESTAURANTS = [
    { id: "bentan",   name: "벤탄빌라",          emoji: "🍜", kind: "베트남·태국",   price: 1, hours: "일 11:00–21:00 (LO 20:30)", menu: "쌀국수 1만 · 팟타이 1.35만 · 똠얌꿍 1.9만", desc: "베트남·태국을 한 번에 여행하는 곳. 쌀국수 한 그릇 1만 원으로 출국 수속 끝, 똠얌꿍 시키면 비즈니스석 업그레이드 ✈️", url: PLACE(1718113572) },
    { id: "hongkong", name: "홍콩반점",          emoji: "🥟", kind: "중식",         price: 1, hours: "일 10:30–20:30 (LO 20:00)", menu: "짜장면 7천 · 짬뽕 9천 · 탕수육 1.68만~", desc: "백종원 선생님의 검증된 그 맛. 짜장이냐 짬뽕이냐, 인생 최대 난제를 7천 원에 고민할 수 있는 가성비 성지 🥢", url: PLACE(1899397279), warn: "단체석 표시 없음 · 8명 가능한지 전화 확인" },
    { id: "haru",     name: "하루엔소쿠",        emoji: "🍛", kind: "돈카츠·일식",   price: 1, hours: "일 10:00–21:00 (LO 20:20)", menu: "로스카츠 1.15만 · 하루카츠 1.25만 · 특로스 1.39만", desc: "겉바속촉의 교과서, 돈카츠 전문점. 벨포레 바로 옆 건물이라 걸어서 1분, 한 입 베어 물면 1초 만에 행복 🐷", url: PLACE(35905708) },
